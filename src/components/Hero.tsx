...
export function Hero() {
  return (
    <section className="min-h-[60vh] flex items-center justify-center">
      <div className="w-full max-w-5xl px-4 md:px-6 text-center space-y-4">
        ...
        <p className="max-w-xl text-muted-foreground text-lg md:text-xl mx-auto">
          I&apos;m a Data Scientist and Engineer with 7+ years of experience building bioinformatics platforms, 
          cloud infrastructure, full-stack applications, and AI-driven tools.
        </p>
