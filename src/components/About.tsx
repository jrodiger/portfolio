...
export function About() {
  return (
    <section id="about" className="flex flex-col items-center justify-center min-h-[60vh] scroll-mt-24">
      <div className="container w-full max-w-5xl px-4 md:px-6 grid gap-8 lg:grid-cols-[2fr_1fr] lg:gap-12 items-start text-left">
